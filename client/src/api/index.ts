...
export const logIn = (userEmail: string,
    userPassword: string) => axios.post(`${url}/login`, { data: { userEmail, userPassword } });

export const signUp = (userEmail: string,
    userPassword: string,
    userFirstName: string,
    userLastName: string) => axios.post(`${url}/signup`, { data: { userEmail, userPassword, userFirstName, userLastName } });
